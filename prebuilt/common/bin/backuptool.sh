...
# dotOS installed check
if ( ! grep -q "^ro.dot.build.version=" /system/build.prop ); then
  echo "Not backing up files as dotOS is not installed"
  return 0
fi

# Check whether installed Android Version is 7.1*
