...
ALARM_PATH := vendor/dot/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/dot/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/dot/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/dot/prebuilt/common/media/audio/ui
