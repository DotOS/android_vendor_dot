...
ifdef DOT_BUILD_TYPE
   ...
   LIST = $(shell curl -s 
https://raw.githubusercontent.com/DotOS/android_vendor_dot/dot-o/dot.devices)
   FOUND_DEVICE =  $(filter $(CURRENT_DEVICE), $(LIST))
    ...
    #    
persist.ota.manifest=https://raw.githubusercontent.com/DotOS/services_apps_ota/dot-n/$(shell 
echo "$(TARGET_PRODUCT)" | cut -d'_' -f 2,3).xml 
endif
